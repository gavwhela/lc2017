...
instance YesodAuth App where
    ...
    -- This is in general not used, but the default implementation
    -- assumes that you are using some persistent backing due to some
    -- caching details. It is overridden here to prevent needing any
    -- of that.
    maybeAuthId = do
